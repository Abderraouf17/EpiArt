            ...
            <div class="flex justify-between items-center h-20">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button @click="searchOpen = true"
                        class="flex items-center gap-2 px-3 py-2 rounded-lg font-medium transition-all hover:shadow-md"
                    ...
                    <button @click="cartOpen = true"
                        class="relative flex items-center gap-2 px-3 py-2 rounded-lg font-medium transition-all hover:shadow-md"
                        :class="currentMode === 'spice' ? 'text-spice-800 hover:bg-spice-50' : 'text-beauty-800 hover:bg-beauty-50'">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @auth
                        <a href="{{ url('/dashboard') }}"
                            class="flex items-center gap-2 px-4 py-2 rounded-full text-white text-sm font-medium transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
        ...
        <div class="absolute inset-0 transition-opacity duration-700 ease-in-out" x-show="currentMode === 'spice'"
            ...
            <div class="relative z-10 h-full flex flex-col justify-center items-center text-white px-8 md:px-16 pt-20">
                <div class="text-center mb-12">
                    <span class="uppercase tracking-[0.2em] text-sm mb-4 font-semibold text-amber-300 block">Authentic
                        Flavors</span>
                            ...
                            <a href="/shop/product/{{ $product->slug }}" class="group">
                                <div
                                    ...
                                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                                        ...
                                        @endif
                                        <div
                                            class="absolute top-3 right-3 bg-spice-600 text-white px-3 py-1 rounded-full text-xs font-semibold">
                                            Featured</div>
                                    </div>
                                    <div class="p-4">
                                        <h3
                                            class="font-semibold text-gray-900 group-hover:text-spice-600 transition mb-2 truncate">
                                            {{ $product->name }}
                                        </h3>
                                        <p class="text-gray-600 text-sm mb-3 line-clamp-2">{{ $product->description }}</p>

                                        <div class="flex justify-between items-center mt-3">
                                            <p class="text-spice-600 font-bold text-lg">{{ number_format($product->price, 0) }}
                                                DA</p>
                            ...
                            <a href="/shop/product/{{ $product->slug }}" class="group">
                                <div
                                    ...
                                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                                        ...
                                        @endif
                                        <div
                                            class="absolute top-3 right-3 bg-amber-500 text-white px-3 py-1 rounded-full text-xs font-semibold">
                                            New</div>
                                    </div>
                                    <div class="p-4">
                                        <h3
