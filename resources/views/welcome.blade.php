...
<body class="font-sans antialiased text-gray-800 bg-white" x-data="shopStore()">
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 md:h-20">
                ...
                <div class="flex items-center space-x-1 sm:space-x-2 md:space-x-4">
                        ...
                        <!-- Mobile: Hamburger Menu -->
                            <div class="md:hidden" x-data="{ mobileMenuOpen: false }">
                                ...
                                <div x-show="mobileMenuOpen" 
                                     ...
                                     class="absolute right-4 mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 py-2 z-50">
                            ...
                            <a href="{{ url('/dashboard') }}"
                                class="hidden md:flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1.5 md:py-2 rounded-full text-white text-xs md:text-sm font-medium transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="hidden md:inline">
                                @csrf
                                <button type="submit"
                                    class="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1.5 md:py-2 rounded-full text-white text-xs md:text-sm font-medium transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="flex items-center gap-1 px-2 md:px-5 py-1.5 md:py-2.5 rounded-full text-white text-xs md:text-sm font-bold transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 hover:scale-105 ring-1 ring-black/5"
                                :class="currentMode === 'spice' ? 'text-white' : 'text-white'"
    ...
    <div class="relative h-[70vh] md:h-screen w-full overflow-hidden top-0 left-0">
        ...
        <div class="absolute inset-0 transition-opacity duration-700 ease-in-out" x-show="currentMode === 'spice'"
            ...
            <div
                class="relative z-10 h-full flex flex-col justify-center items-center text-white px-4 sm:px-8 md:px-16 pt-16 md:pt-20">
                <div class="text-center mb-8 md:mb-12">
                    <span
                        class="uppercase tracking-[0.2em] text-xs sm:text-sm mb-3 md:mb-4 font-semibold text-amber-300 block">Authentic
                        Flavors</span>
                    <h1
                        class="font-serif text-3xl sm:text-4xl md:text-7xl lg:text-8xl mb-4 md:mb-6 font-bold leading-tight">
                        Taste The Tradition</h1>
                    <p
                        class="text-sm sm:text-base md:text-xl text-gray-200 max-w-2xl mx-auto mb-6 md:mb-10 leading-relaxed px-4">
        ...
        <div class="absolute inset-0 transition-opacity duration-700 ease-in-out" x-show="currentMode === 'beauty'"
            ...
            <div
                ...
                <div class="text-center mb-8 md:mb-12">
                    <span
                        class="uppercase tracking-[0.2em] text-xs sm:text-sm mb-3 md:mb-4 font-semibold text-pink-300 block">Pure
                        & Organic</span>
                    <h1
                        class="font-serif text-3xl sm:text-4xl md:text-7xl lg:text-8xl mb-4 md:mb-6 font-bold leading-tight">
                        Radiant Natural Beauty</h1>
                    <p
                        class="text-sm sm:text-base md:text-xl text-gray-200 max-w-2xl mx-auto mb-6 md:mb-10 leading-relaxed px-4">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-20 min-h-[500px]">
        ...
        <div x-show="currentMode === 'spice'" x-transition.opacity.duration.500ms>
            <div class="text-center mb-10 md:mb-16">
                <h2 class="text-2xl md:text-3xl font-serif font-bold text-spice-900 mb-3 md:mb-4">Curated Spice
                    Collections</h2>
            ...
            <div id="featured-section" class="py-12 md:py-20 scroll-mt-24">
                <div class="text-center mb-10 md:mb-16">
                    <h2 class="text-2xl md:text-3xl font-serif font-bold text-spice-900 mb-3 md:mb-4">Featured Products
                    </h2>
                    <div class="h-1 w-20 bg-spice-500 mx-auto"></div>
                </div>
                                ...
                                <div
                                    ...
                                    <div class="p-3 md:p-4">
                                        ...
                                        <div class="flex justify-between items-center mt-2 md:mt-3">
                                            <p class="text-spice-600 font-bold text-base md:text-lg">
                                                {{ number_format($product->price, 0) }}
                                                DA
                                            </p>
                                            <div class="flex gap-1.5 md:gap-2 z-20 relative">
                                                <button @click.prevent="addToWishlist({{ $product->id }})"
                                                    :class="isInWishlist({{ $product->id }}) ? 'text-red-500 bg-red-50' : 'text-gray-500 bg-gray-100 hover:text-red-500 hover:bg-red-50'"
                                                    class="w-9 h-9 md:w-8 md:h-8 rounded-full flex items-center justify-center transition"
            ...
            <div id="new-arrivals-section" class="py-12 md:py-20 scroll-mt-24">
                <div class="text-center mb-10 md:mb-16">
                    <h2 class="text-2xl md:text-3xl font-serif font-bold text-spice-900 mb-3 md:mb-4">New in the Kitchen
                    </h2>
                    <div class="h-1 w-20 bg-spice-500 mx-auto"></div>
                </div>
            ...
            <div id="all-products" class="mt-12 md:mt-20 scroll-mt-24" x-data="{ selectedSpiceCategory: 'all' }">
                <div class="text-center mb-6 md:mb-8">
                    ...
                    <p class="text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-4">Browse our complete collection
                        of premium spices</p>
                </div>
                ...
                <div class="mb-6 md:mb-8 overflow-x-auto scrollbar-hide">
                    <div
                        class="flex flex-nowrap md:flex-wrap justify-start md:justify-center gap-2 md:gap-3 px-4 md:px-0 min-w-max md:min-w-0">
                        ...
                        <a href="/shop/product/{{ $product->slug }}" class="group"
                            ...
                            <div
                                ...
                                <div class="relative aspect-square overflow-hidden bg-gray-100">
                                    ...
                                    @if($product->category)
                                        <div
                                            class="absolute top-2 md:top-3 left-2 md:left-3 bg-white/90 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold text-spice-800">
                                ...
                                <div class="p-3 md:p-4">
                                    <h3
                                        class="font-semibold text-sm md:text-base text-gray-900 mb-1 md:mb-2 group-hover:text-spice-700 transition-colors">
                                        {{ $product->name }}
                                    </h3>
                                    <p class="text-gray-600 text-xs md:text-sm mb-2 md:mb-3 line-clamp-2">
                                        {{ $product->description }}
                                    ...
                                    <div class="flex justify-between items-center mt-2 md:mt-3">
                                        <p class="text-spice-700 font-bold text-base md:text-lg">
                                            {{ number_format((float) $product->price, 0) }} DA
                                        </p>
                                        <div class="flex gap-1.5 md:gap-2 z-20 relative">
                                            <button @click.prevent="addToWishlist({{ $product->id }})"
                                                :class="isInWishlist({{ $product->id }}) ? 'text-red-500 bg-red-50' : 'text-gray-500 bg-gray-100 hover:text-red-500 hover:bg-red-50'"
        ...
        <div x-show="currentMode === 'beauty'" x-transition.opacity.duration.500ms>
                ...
                <div class="grid grid-cols-2 gap-3 md:hidden">
                    <a href="javascript:void(0)"
                        ...
                        <div class="relative w-full h-40 overflow-hidden rounded-2xl shadow-lg">
                            <img src="https://images.unsplash.com/photo-1556228720-195a672e8a03?w=800&h=1200&fit=crop"
                                class="w-full h-full object-cover" alt="Skincare">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                            <div class="absolute inset-0 flex items-end justify-center pb-4">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Skincare</h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:void(0)"
                        ...
                        class="group cursor-pointer">
                        <div class="relative w-full h-40 overflow-hidden rounded-2xl shadow-lg">
                            <img src="https://images.unsplash.com/photo-1522338242992-e1a54906a8da?w=800&h=1200&fit=crop"
                                class="w-full h-full object-cover" alt="Haircare">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                            <div class="absolute inset-0 flex items-end justify-center pb-4">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Haircare</h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:void(0)"
                        ...
                        class="group cursor-pointer">
                        <div class="relative w-full h-40 overflow-hidden rounded-2xl shadow-lg">
                            <img src="https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=800&h=1200&fit=crop"
                                class="w-full h-full object-cover" alt="Aromatherapy">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                            <div class="absolute inset-0 flex items-end justify-center pb-4">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Aromatherapy</h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:void(0)"
                        ...
                        class="group cursor-pointer">
                        <div class="relative w-full h-40 overflow-hidden rounded-2xl shadow-lg">
                            <img src="https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=800&h=1200&fit=crop"
                                class="w-full h-full object-cover" alt="Cosmetics">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                            <div class="absolute inset-0 flex items-end justify-center pb-4">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Cosmetics</h3>
                            </div>
                        </div>
                    </a>
                    ...
                    <a href="javascript:void(0)"
                        onclick="document.getElementById('all-beauty-products').scrollIntoView({behavior: 'smooth'});"
                        class="group cursor-pointer col-span-2">
                        <div class="relative w-full h-40 overflow-hidden rounded-2xl shadow-lg">
                            <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=800&h=1200&fit=crop"
                                class="w-full h-full object-cover" alt="Wellness">
                            <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent"></div>
                            <div class="absolute inset-0 flex items-end justify-center pb-4">
                                <h3 class="text-lg font-bold text-white uppercase tracking-wider">Wellness</h3>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="py-12 md:py-20 scroll-mt-24" id="featured-section-beauty">
                <div class="text-center mb-10 md:mb-16">
                    <h2 class="text-2xl md:text-3xl font-serif font-bold text-purple-900 mb-3 md:mb-4">Featured Beauty
                        Products</h2>
                    <div class="h-1 w-20 bg-pink-500 mx-auto"></div>
                </div>
                            ...
                            <a href="/shop/product/{{ $product->slug }}" class="group">
                                <div
                                    ...
                                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                                        ...
                                        @else
                                            <div
                                                class="w-full h-full bg-gradient-to-br from-pink-50 to-purple-100 flex items-center justify-center">
                                                <svg class="w-12 h-12 text-pink-300" fill="currentColor" viewBox="0 0 20 20">
                                                    <path d="M10 2a8 8 0 100 16 8 8 0 000-16z" />
                                                </svg>
                                            </div>
                                        @endif
                                        <div
                                            class="absolute top-2 md:top-3 right-2 md:right-3 bg-pink-600 text-white px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold">
                                            Featured</div>
                                    </div>
                                    <div class="p-3 md:p-4">
                                        <h3
                                            class="font-semibold text-sm md:text-base text-gray-900 group-hover:text-pink-600 transition mb-1 md:mb-2 truncate">
                                            {{ $product->name }}
                                        </h3>
                                        <p class="text-gray-600 text-xs md:text-sm mb-2 md:mb-3 line-clamp-2">
                                            {{ $product->description }}
                                        ...
                                        <div class="flex justify-between items-center mt-2 md:mt-3">
                                            <p class="text-pink-600 font-bold text-base md:text-lg">
                                            ...
                                            <div class="flex gap-1.5 md:gap-2 z-20 relative">
                                                ...
                                                <button
                                                    @click.prevent="addToCart({ id: {{ $product->id }}, name: '{{ addslashes($product->name) }}', price: {{ $product->price }}, image: '{{ $product->images->first()?->image_url ?? '' }}' })"
                                                    class="w-9 h-9 md:w-8 md:h-8 rounded-full bg-pink-600 flex items-center justify-center text-white hover:bg-pink-700 transition shadow-md">
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                            d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" />
                                                    </svg>
            ...
            <div class="py-12 md:py-20 scroll-mt-24" id="new-arrivals-section-beauty">
                <div class="text-center mb-10 md:mb-16">
                    <h2 class="text-2xl md:text-3xl font-serif font-bold text-purple-900 mb-3 md:mb-4">New Beauty
                        Essentials</h2>
                    <div class="h-1 w-20 bg-pink-500 mx-auto"></div>
                </div>
                            ...
                            <a href="/shop/product/{{ $product->slug }}" class="group">
                                <div
                                    ...
                                    <div class="relative aspect-square overflow-hidden bg-gray-100">
                                        ...
                                        @endif
                                        <div
                                            class="absolute top-2 md:top-3 right-2 md:right-3 bg-purple-500 text-white px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold">
                                            New</div>
                                    </div>
                                    <div class="p-3 md:p-4">
                                        <h3
            ...
            <div id="all-beauty-products" class="mt-12 md:mt-20 scroll-mt-24"
                x-data="{ selectedBeautyCategory: 'all' }">
                <div class="text-center mb-6 md:mb-8">
                    <h2 class="text-2xl md:text-4xl font-bold text-purple-900 mb-3 md:mb-4">All Beauty Products</h2>
                    <p class="text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-4">Browse our complete collection
                        of natural beauty products</p>
                </div>
                ...
                <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
                    @foreach(App\Models\Product::where('type', 'beauty')->with(['images', 'category'])->get() as $product)
                        <a href="/shop/product/{{ $product->slug }}" class="group"
                            ...
                            x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">
                            <div
                                class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 h-full flex flex-col">
                                <div class="relative aspect-square overflow-hidden bg-gray-100">
                                    @if($product->images->first())
                                        <img src="{{ $product->images->first()->image_url }}" alt="{{ $product->name }}"
                                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                                    @else
                                        <div
                                            class="w-full h-full bg-gradient-to-br from-purple-50 to-pink-100 flex items-center justify-center">
                                    ...
                                    @if($product->category)
                                        <div
                                            class="absolute top-2 md:top-3 left-2 md:left-3 bg-white/90 backdrop-blur-sm px-2 md:px-3 py-0.5 md:py-1 rounded-full text-xs font-semibold text-purple-800">
                                            {{ $product->category->name }}
                                        </div>
                                    @endif
                                </div>
                                <div class="p-3 md:p-4 flex-1 flex flex-col">
                                    <h3
                                        class="font-semibold text-sm md:text-base text-gray-900 mb-1 md:mb-2 group-hover:text-purple-700 transition-colors">
                                        {{ $product->name }}
                                    </h3>
                                    <p class="text-gray-600 text-xs md:text-sm mb-2 md:mb-3 line-clamp-2 flex-1">
                                        {{ $product->description }}
                                    </p>

                                    <div class="flex justify-between items-center mt-auto">
                                        <p class="text-purple-700 font-bold text-base md:text-lg">
                                            {{ number_format((float) $product->price, 0) }} DA
                                        </p>
                                        <div class="flex gap-1.5 md:gap-2 z-20 relative">
                                            <button @click.prevent="addToWishlist({{ $product->id }})"
                                            ...
                                            <button
                                                @click.prevent="addToCart({ id: {{ $product->id }}, name: '{{ addslashes($product->name) }}', price: {{ $product->price }}, image: '{{ $product->images->first()?->image_url ?? '' }}' })"
                                                class="w-9 h-9 md:w-8 md:h-8 rounded-full bg-pink-600 hover:bg-pink-700 flex items-center justify-center text-white transition shadow-md hover:shadow-lg"
                                                title="Add to Cart">
    ...
    <div x-show="searchOpen" @click.away="searchOpen = false" x-transition:enter="transition ease-out duration-200"
        ...
        x-transition:leave-end="opacity-0" class="fixed inset-0 bg-black bg-opacity-50 z-50 overflow-y-auto"
        style="display: none;">
        <div class="min-h-screen px-4 py-8">
            <div @click.stop class="bg-white rounded-2xl shadow-2xl max-w-7xl mx-auto">
                <!-- Header -->
                <div class="p-4 md:p-6 border-b border-gray-200">
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="font-serif text-2xl md:text-3xl font-bold text-gray-900">Search Products</h2>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" x-model="searchQuery" @input="performSearch"
                            ...
                            class="w-full pl-10 pr-4 py-3 text-base border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#8B3A3A] focus:border-transparent transition"
                            autofocus>
                    </div>
                </div>
                ...
                <div class="p-4 md:p-6">
                    <template x-if="searchQuery.length === 0">
                        <div class="text-center py-16">
                            ...
                            <p class="text-gray-500 text-lg">Start typing to search for products...</p>
                        </div>
                    </template>
                    ...
                    <template x-if="searchQuery.length > 0 && searchResults.length === 0">
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-serif font-bold text-gray-900 mb-2">No results found</h3>
                    ...
                    <template x-if="searchResults.length > 0">
                        <div>
                            <p class="text-sm text-gray-500 mb-4"
                                x-text="`Found ${searchResults.length} product${searchResults.length !== 1 ? 's' : ''}`">
                            </p>
                            <div
                                class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 max-h-[60vh] overflow-y-auto">
                                <template x-for="result in searchResults" :key="result.id">
                                    <a :href="`/shop/product/${result.slug}`"
                                        ...
                                        <div class="p-3 md:p-4 flex-1 flex flex-col">
                                            <div class="flex-1">
                                                <h3 class="font-medium text-gray-900 mb-1 line-clamp-2 text-sm md:text-base"
                                                    x-text="result.name"></h3>
                                                <p class="text-xs md:text-sm text-gray-500 line-clamp-1"
                                                    x-text="result.category"></p>
                                            </div>

                                            <div
                                                class="flex items-center justify-between pt-3 border-t border-gray-50 mt-auto">
                                                <p class="font-serif font-bold text-base md:text-lg"
                                                    :class="result.category_type === 'beauty' ? 'text-purple-600' : 'text-[#8B3A3A]'">
                                                    <span x-text="result.price"></span> <span
                                                        class="text-xs font-sans font-normal text-gray-500">DA</span>
                                                </p>
                                                <div class="w-8 h-8 rounded-full flex items-center justify-center transition"
                                                    :class="result.category_type === 'beauty' ? 'bg-purple-100 text-purple-600 group-hover:bg-purple-600 group-hover:text-white' : 'bg-[#8B3A3A]/10 text-[#8B3A3A] group-hover:bg-[#8B3A3A] group-hover:text-white'">
